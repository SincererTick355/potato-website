...
def russet():
    return render_template("potato_type.html",
                           ...
                           image_url="https://source.unsplash.com/600x400/?russet-potato")
...
def red():
    return render_template("potato_type.html",
                           ...
                           image_url="https://source.unsplash.com/600x400/?red-potato")
...
def yukon_gold():
    return render_template("potato_type.html",
                           ...
                           image_url="https://source.unsplash.com/600x400/?yukon-gold-potato")
...
def fingerling():
    return render_template("potato_type.html",
                           ...
                           image_url="https://source.unsplash.com/600x400/?fingerling-potato")
...
def purple():
    return render_template("potato_type.html",
                           ...
                           image_url="https://source.unsplash.com/600x400/?purple-potato")
...
def new_potatoes():
    return render_template("potato_type.html",
                           ...
                           image_url="https://source.unsplash.com/600x400/?new-potato")
